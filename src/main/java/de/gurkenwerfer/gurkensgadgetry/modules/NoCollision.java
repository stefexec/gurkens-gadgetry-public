...
public class NoCollision extends Module {
    ...
    // THIS IS STOLEN FROM VECTOR ADDON BUT THE LAZY FUCK DOESN'T UPDATE HIS PLUGIN SO FUCK HIM
    ...
    public NoCollision() {
        super(GurkensGadgetry.CATEGORY, "no-collision", "Removes block and world border collision client-side.");
    }
